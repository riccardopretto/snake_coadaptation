...
class Snake():
  segment_list = ["seg1_body_layer0", "seg1_body_layer1", "seg2_body_layer0",  "seg2_body_layer1", "seg3_body_layer0", "seg3_body_layer1", "seg4_body_layer0", "seg4_body_layer1", "seg5_body_layer0", "seg5_body_layer1", "seg6_body_layer0", "seg6_body_layer1", "seg7_body_layer0", "seg7_body_layer1", "seg8_body_layer0", "seg8_body_layer1"]  # track these contacts with ground

  def __init__(self, design = None):
    self._adapted_xml_file = tempfile.NamedTemporaryFile(delete=False, prefix='snake_v14_', suffix='.xml')
    self._adapted_xml_filepath = self._adapted_xml_file.name
    file = self._adapted_xml_filepath
    self._adapted_xml_file.close()
    atexit.register(cleanup_func_for_tmp, self._adapted_xml_filepath)
    self.adapt_xml(self._adapted_xml_filepath, design)
    #WalkerBase.__init__(self, file, "torso", action_dim=6, obs_dim=26, power=0.90)   #--------------------------------------to figure out

  def adapt_xml(self, file, design = None):
      with open(os.path.join(currentdir, 'snake_v14.xml'), 'r') as fd:
            xml_string = fd.read()
      height = 1.0  #it s not even in the xml file
      seg_1_0 = 50
      seg_1_1 = 50
      seg_2_0 = 50
      seg_2_1 = 50
      ...
      seg_8_1 = 50
      if design is None:
        seg_1_0,seg_1_1, seg_2_0,seg_2_1, seg_3_0,seg_3_1, seg_4_0,seg_4_1, seg_5_0,seg_5_1, seg_6_0,seg_6_1, seg_7_0,seg_7_1, seg_8_0,seg_8_1 = np.random.uniform(low=0, high=149, size=8)
      else:
        seg_1_0,seg_1_1, seg_2_0,seg_2_1, seg_3_0,seg_3_1, seg_4_0,seg_4_1, seg_5_0,seg_5_1, seg_6_0,seg_6_1, seg_7_0,seg_7_1, seg_8_0,seg_8_1 = design
      # height = max(.145 * bth_r + .15 * bsh_r + .094 * bfo_r, .133 * fth_r + .106 * fsh_r +  .07 * ffo_r)
      # height *= 2.0 + 0.01
      ...
      ### segment 1
      xml_dict['mujoco']['worldbody']['body']['body'][0]['geom']['@pos'] = '-0.0665 0 -0.0157'
      xml_dict['mujoco']['worldbody']['body']['body'][0]['geom']['@pos'] = '{} 0 {}'.format(.1 * bth_r, -.13 * bth_r)
