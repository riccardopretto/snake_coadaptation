...
sac_pso_batch = {
    ...
    'iterations_init' : 300,           #300         # Number of episodes for all initial designs as provided by the environment class
    'iterations_random': 300,         #100          # Number of episodes for all random designs TODO: Not used atm
    'iterations' :300,       #100                   # Number of episodes to run for all designs after the initial
    'design_cycles' : 55,       #55                # Number of design adaptations after the initial designs
    ...
    'steps_per_episodes' : 300,                # Number of steps per episode
